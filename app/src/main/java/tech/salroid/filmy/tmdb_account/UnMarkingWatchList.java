 ...
 */
public class UnMarkingWatchList {
    ...
    public void removeFromWatchList(Context context,String media_id,int position){
    ...
    private void removeWatchFinal(String query,int media_id) {
